...
Examples:
  ...
  %(prog)s --dry-run --install     # Preview installation steps
    ...
    action_group.add_argument("--logs", action="store_true", help="Show bot logs")
    action_group.add_argument(
        "--prune",
        action="store_true",
...
def create_stop_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Preview stop actions")
    parser.add_argument(
        "--verbose",
        "-v",
        action="store_true",
