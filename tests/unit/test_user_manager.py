...
class TestUserManager(unittest.TestCase):
    ...
    def test_add_user_new(self, mock_load_json, mock_save_json):
        ...
        mock_load_json.side_effect = lambda f, d: [100, 200] if f == MOCK_USERS_FILE else ([100] if f == MOCK_ADMINS_FILE else d)
        user_manager = UserManager() 
    ...
    def test_remove_admin_success(self, mock_load_json, mock_save_json):
        ...
        mock_load_json.side_effect = lambda f, d: [100, 200] if f == MOCK_USERS_FILE else ([100, 200] if f == MOCK_ADMINS_FILE else d)
        user_manager = UserManager()
